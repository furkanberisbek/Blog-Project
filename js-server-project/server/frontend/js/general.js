...
contactForm.addEventListener('submit', (event) => {
    ...
    // CONTACTFORM BİTİŞ
    // --------------------------------------------------
    // APİ İLE FORM GÖNDERME, İLETİŞİM KURMA BAŞLANGIÇ
    const newForm = {
 ...
 // APİ İLE FORM GÖNDERME, İLETİŞİM KURMA BİTİŞ
// --------------------------------------------------